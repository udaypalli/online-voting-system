        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <p class="text-center mt-3">
                    Don't have an account? <a href="admin_register.jsp">Sign up here</a>.
                </p>
            </div>
        </div>
    </main>
...
<%
    // Database authentication logic for Admin
    if (request.getMethod().equalsIgnoreCase("POST")) {
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                //int adminId = rs.getInt("admin_id"); // From DB query
                //response.sendRedirect("admin_dashboard.jsp?adminId=" + adminId);
            
response.sendRedirect("admin_dashboard.jsp?adminId=" + rs.getInt("admin_id"));
